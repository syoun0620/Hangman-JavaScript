...
hangman.getRandomWord = function() {
  // YOUR CODE HERE
  var randNum = hangman.getRandomInteger(0, hangman.words.length);
  return hangman.words[randNum];
}
...
hangman.getGameStatus = function(word, guesses) {
  ...
  for (var i = 0; i<guesses.length; i++){
    if (hangman.isGuessWrong(word, guesses[i]) == true){
      count++;
    }
  }
